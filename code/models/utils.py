...
def choose_model(model):
    ...
    NetG, NetD, NetC, CLIP_IMG_ENCODER, TEXT_ENCODER = model.NetG, model.NetD, model.NetC, model.CLIP_IMG_ENCODER, model.TEXT_ENCODER
    return NetG,NetD,NetC,CLIP_IMG_ENCODER, TEXT_ENCODER
