...
from models.utils import mkdir_p,get_rank,merge_args_yaml,get_time_stamp,save_args
from models.utils import load_models_opt,save_models_opt,save_models,load_npz,params_count
from models.perpare import prepare_dataloaders,prepare_models
from models.modules import sample_one_batch as sample, test as test, train as train
from models.datasets import get_fix_data


def parse_args():
    parser = argparse.ArgumentParser(description='Text2Img')
    parser.add_argument('--cfg', dest='cfg_file', type=str, default='../coco.yml', help='optional config file')
    parser.add_argument('--num_workers', type=int, default=4, help='number of workers(default: {0})'.format(mp.cpu_count() - 1)) help='the stamp of model')
    ...
    parser.add_argument('--model', type=str, default='model',  help='the model for training')
    ...
    parser.add_argument('--multi_gpus', type=str, default='False', help='if use multi-gpu')
